...
public class TestVueloStore {
	...
	public void paraLaFecha23102018TieneSacadoPasajeEnTahitiLaPersonaConDNI39146925(){
		...
		vuelo1.setDestino(Destino.Tahiti);
		...
		assertEquals(fechas, VueloStore.store().getFechasDeDestinoParaUnaPersonaTodosLosVuelos(pasajero2, Destino.Tahiti));
	}
	
	@Test
	public void paraLasFechas23102020Y11082019TieneSacadoPasajesEnBarcelonaLaPersonaConDNI39146980(){
		//Le seteo el destino, la fecha, creo la venta, etc al vuelo
		vuelo1.setDestino(Destino.Barcelona);
		vuelo2.setDestino(Destino.Barcelona);
		...
		assertEquals(fechas, VueloStore.store().getFechasDeDestinoParaUnaPersonaTodosLosVuelos(pasajero2, Destino.Barcelona));
	}
